...
import { Building, ChevronDown, ChevronUp, Plus, Edit3, Trash2 } from 'lucide-react';
...
export default function ComptesSection({
  ...
  return (
    <div 
      className="backdrop-blur-sm rounded-2xl p-4 shadow-sm border mb-4 animate-fade-in-up stagger-2"
      style={cardStyle}
    >
      <button 
        onClick={onToggle} 
      ...
      {isActive && (
        <div className="mt-4 space-y-3">
          <button 
            onClick={onAddCompte} 
            className="w-full flex items-center justify-center gap-2 px-4 py-2 rounded-xl font-medium text-sm transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] shadow-lg"
            style={{ 
              ...
              >
                ...
                <div className="flex gap-1">
                  ...
                  <button 
                    ...
                    className="p-1.5 rounded-lg hover:bg-red-500/20 transition-all duration-200 hover:scale-110"
                  >
