...
export default function TransactionForm({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fadeIn">
      <div 
        className="rounded-2xl w-full max-w-md border animate-slideUp flex flex-col max-h-[90vh]"
        style={{ background: theme.colors.secondary, borderColor: theme.colors.cardBorder }}
      >
        {/* Header - Fixed */}
        <div className="flex items-center justify-between p-4 border-b shrink-0" style={{ borderColor: theme.colors.cardBorder }}>
        ...
        <div className="flex gap-3 p-4 border-t shrink-0" style={{ borderColor: theme.colors.cardBorder }}>
          <button 
            onClick={onClose} 
